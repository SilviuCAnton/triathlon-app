...
set CLASSPATH=%APP_HOME%\lib\triathlon-app-1.0-SNAPSHOT.jar;%APP_HOME%\lib\postgresql-42.2.10.jre7.jar;%APP_HOME%\lib\spring-aop-4.3.26.RELEASE.jar;%APP_HOME%\lib\spring-beans-4.3.26.RELEASE.jar;%APP_HOME%\lib\spring-core-4.3.26.RELEASE.jar;%APP_HOME%\lib\commons-logging-1.2.jar
